...
const SEND_GRID_API_KEY="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"
...
exports.postForgotPassword = async (req, res, next) => {
 ...
 try{
  ...
  user.otp=otp;
  user.otpExpiry=Date.now()+30*MiLLIS_IN_MINUTES;
  await user.save();
  const forgotEmail={
    to:email,
    from:'aman.kathat011@gmail.com',
