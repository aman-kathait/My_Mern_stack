...
const MONGO_DB_URL = `mongodb+srv://${process.env.MONGO_DB_USERNAME}:${process.env.MONGO_DB_PASSWORD}@amancluster.ujtan.mongodb.net/${process.env.MONGO_DB_DATABASE}`;
...
const fileFilter = (req, file, cb)=>{ 
  const isValidFile= (['image/png', 'image/jpg', 'image/jpeg'].includes(file.mimetype));
    cb(null, isValidFile);
  }
